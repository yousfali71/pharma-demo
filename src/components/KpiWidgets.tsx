    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="p-5 rounded-[24px] bg-white/90 backdrop-blur-md border border-purple-100/60 shadow-sm shadow-purple-900/5 hover:shadow-md transition-all">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-extrabold text-slate-400 uppercase tracking-wider">المناديب النشطون اليوم</span>
        ...
        <div className="flex items-baseline justify-between">
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-slate-900 tracking-tight">{activeRepsCount}</span>
            <span className="text-xs text-slate-400 font-bold">/ {totalRepsCount} مندوب ميداني</span>
          </div>
      ...
      <div className="p-5 rounded-[24px] bg-white/90 backdrop-blur-md border border-purple-100/60 shadow-sm shadow-purple-900/5 hover:shadow-md transition-all">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-extrabold text-slate-400 uppercase tracking-wider">تغطية الزيارات الميدانية</span>
        ...
        <div className="flex items-baseline justify-between">
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-slate-900 tracking-tight">{coveragePct}%</span>
            <span className="text-xs text-slate-400 font-bold">({totalActualVisits}/{totalPlannedVisits} زيارة)</span>
          </div>
          <span className="flex items-center text-[10px] font-bold text-cyan-700 bg-cyan-50 px-2 py-0.5 rounded-full border border-cyan-100">
            <ArrowUpRight className="w-3 h-3 mr-0.5" /> +5.2% عن الهدف
          </span>
        </div>
        <div className="mt-3 w-full bg-slate-100 h-2 rounded-full overflow-hidden">
          <div
      ...
      <div className="p-5 rounded-[24px] bg-white/90 backdrop-blur-md border border-purple-100/60 shadow-sm shadow-purple-900/5 hover:shadow-md transition-all">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-extrabold text-slate-400 uppercase tracking-wider">العهدة المالية المعلقة</span>
      ...
      <div className="p-5 rounded-[24px] bg-white/90 backdrop-blur-md border border-purple-100/60 shadow-sm shadow-purple-900/5 hover:shadow-md transition-all">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-extrabold text-slate-400 uppercase tracking-wider">قيمة مبيعات اليوم</span>
